...
#DEFAULT_IMG  <- "D:/Dropbox Sync 나노바이오/Dropbox/@Manuscript 원고, 연구 topic/^mIO drug treatment_DSS TERM 조직재생학회지/!data deposit 데이터 논문/data 1/iOrganoAssay4/1.Microscopy"
#DEFAULT_SEG  <- "D:/Dropbox Sync 나노바이오/Dropbox/@Manuscript 원고, 연구 topic/^mIO drug treatment_DSS TERM 조직재생학회지/!data deposit 데이터 논문/data 1/iOrganoAssay4/2.Segmentation"
#DEFAULT_MET  <- "D:/Dropbox Sync 나노바이오/Dropbox/@Manuscript 원고, 연구 topic/^mIO drug treatment_DSS TERM 조직재생학회지/!data deposit 데이터 논문/data 1/iOrganoAssay4/3.Metrics"
...
server <- function(input, output, session){
  ...
  output$violinPlot <- renderPlot({
    ...
    ggplot(all_data,
     ...
     # geom_point(size=input$violin_pt) +
     #  geom_line(linewidth=input$violin_line) +
